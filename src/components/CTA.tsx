    ...
    <section className="relative py-16 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-2xl border border-brand-100 bg-gradient-to-br from-brand-50 via-white to-sky-50 p-8 text-center shadow-sm sm:rounded-3xl sm:p-12 lg:p-16">
          ...
          <h2 className="font-display text-2xl font-bold text-slate-950 sm:text-4xl lg:text-5xl">Tell us what is slowing the business down</h2>
          <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-slate-600 sm:mt-5 sm:text-base">
            You do not need a finished technical brief. Explain the process, the problem and what you want to improve. We can help work out what should be built from there.
          </p>
          <Link
            to="/contact"
