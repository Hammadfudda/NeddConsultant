        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 sm:py-24 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:px-8">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center rounded-xl border border-white/15 bg-white/5 px-6 py-4 text-sm font-semibold hover:bg-white/10"
              >
          ...
          <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900 p-3 shadow-2xl shadow-blue-950/50">
            <img
              src={softwareImage}
              alt="Leave management software workspace"
        ...
        <div className="mx-auto grid max-w-7xl gap-5 px-4 sm:px-6 lg:grid-cols-3 lg:px-8">
          {[
            [
              UserRound,
              'Employee',
              'Apply leave, see balances, track status, view history and manage leave changes from one portal.',
            ],
            [
              ClipboardCheck,
              'Manager',
              'Review the requests that need your action, approve or reject with context and see team availability.',
            ],
            [
              UsersRound,
              'Admin',
              'Manage people, master data, policies, reports, audit history and company-wide leave administration.',
            ],
          ].map(([Icon, label, text]) => {
            ...
            return (
              <div
                key={label as string}
                className="rounded-3xl border border-white/10 bg-[#091827] p-7"
              >
      ...
      <section className="border-y border-white/10 bg-[#091827] py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-3 max-w-3xl text-3xl font-bold sm:text-4xl">
            Everything needed to manage leave from one system.
          </h2>
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-3 text-3xl font-bold sm:text-4xl">
            From setup to decision without manual tracking.
          </h2>
          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-4">
            {[
              ...
              <div
                key={number}
                className="rounded-2xl border border-white/10 bg-[#091827] p-6"
              >
                <span className="text-sm font-bold text-sky-400">{number}</span>
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-bold">
              Explore the live Leave Management demo.
            </h2>
          </div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-6 py-4 text-sm font-semibold text-blue-700"
          >
