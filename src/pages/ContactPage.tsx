        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.8fr_1.2fr] lg:px-8">
          <div className="space-y-4">
            <a
              ...
              className="flex gap-4 rounded-2xl border border-white/10 bg-[#091827] p-5"
            >
            ...
            <div className="flex gap-4 rounded-2xl border border-white/10 bg-[#091827] p-5">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6">{SITE.address}</p>
              </div>
            </div>
          </div>

          <form
            className="rounded-3xl border border-white/10 bg-[#091827] p-6 sm:p-8"
          ...
          >
              ...
              {[
                ...
                <label key={name} className="text-sm text-slate-300">
                  ...
                  <input
                    ...
                    className="mt-2 w-full rounded-xl border border-white/10 bg-slate-950 px-4 py-3 text-white outline-none placeholder:text-slate-600 focus:border-sky-400/50"
                  />
                </label>
              ))}
            </div>
            ...
            <label className="mt-5 block text-sm text-slate-300">
              ...
              <textarea
                ...
                rows={6}
                className="mt-2 w-full rounded-xl border border-white/10 bg-slate-950 px-4 py-3 text-white outline-none placeholder:text-slate-600 focus:border-sky-400/50"
                placeholder="Tell us what is slowing the business down..."
              />
            </label>

            <button className="mt-6 rounded-xl bg-blue-600 px-6 py-4 text-sm font-semibold hover:bg-blue-500">
