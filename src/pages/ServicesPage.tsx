        ...
        <div className="mx-auto grid max-w-7xl gap-6 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          {SERVICE_ITEMS.map((service) => (
            <Link
              ...
              className="group overflow-hidden rounded-3xl border border-white/10 bg-[#091827]"
            >
              <img
                src={service.image}
                alt={service.title}
          ...
          <Link
            ...
            className="group overflow-hidden rounded-3xl border border-blue-400/20 bg-gradient-to-br from-blue-700 to-sky-600 lg:col-span-2"
          >
            <div className="grid gap-8 p-7 sm:p-10 lg:grid-cols-[1fr_0.8fr] lg:items-center">
              <div>
                ...
                <p className="mt-4 max-w-2xl text-sm leading-7 text-white/85">
                  One structured system for employees, managers and admin — live balances, approvals, policies, reports and records in one place.
                </p>
              </div>
